 ...
 */
public class ElemeterPanelOld extends JPanel implements ICockpit
{
	...
	public ElemeterPanelOld(int size,
			double max_speed)
	{
...
//		System.out.println ("I="+i);
	...
	public ElemeterPanelOld(int size,  double startAngle, double endAngle,
			double max_speed) {
...
0.0888888
	...
	public ElemeterPanelOld(int size, double f1, double f2, double f3, double f4, double startAngle, double endAngle,
			double max_speed) {
		super();
		this.size = size;
		this.f1 = f1;
